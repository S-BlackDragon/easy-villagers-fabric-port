...
public class IronFarmScreen extends AbstractContainerScreen<IronFarmMenu> {
    ...
    protected void renderBg(GuiGraphics g, float delta, int mx, int my) {
        ...
        drawArrow(g, l + 40, t + 36);

        // 2×2 output grid (slots 1–4, menu x=98/116, y=19/37)
        drawSlot(g, l + 97,  t + 18);
        drawSlot(g, l + 115, t + 18);
        drawSlot(g, l + 97,  t + 36);
        drawSlot(g, l + 115, t + 36);

        // Progress bar (iron farm timer)
        int progress = menu.getIronProgress();
        g.fill(l + 7,  t + 55, l + 139, t + 62, 0xFF373737);
        g.fill(l + 8,  t + 56, l + 138, t + 61, 0xFF333333);
        if (progress > 0)
            g.fill(l + 8, t + 56, l + 8 + 130 * progress / 100, t + 61, 0xFF888888);
